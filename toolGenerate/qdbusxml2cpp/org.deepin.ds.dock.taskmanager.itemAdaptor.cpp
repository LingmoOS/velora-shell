...
#include "./dde-shell/toolGenerate/qdbusxml2cpp/org.lingmo.ds.dock.taskmanager.itemAdaptor.h"
...
{
    // handle method call org.lingmo.ds.Dock.TaskManager.Item.handleClick
    QMetaObject::invokeMethod(parent(), "handleClick", Q_ARG(QString, action));
}

void ItemAdaptor::setDocked(bool docked)
{
    // handle method call org.lingmo.ds.Dock.TaskManager.Item.setDocked
